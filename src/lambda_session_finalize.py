...
def build_confirmation_email(*, date=None, time_range=None, site_name=None,
    ...
    if todos:
        def _row(t):
            ...
            # Greyed, so a reader scanning for what they owe can stop at the
            # last black row. The information is still there for the reader who
            # wants to know what the meeting was about.
